...
|1 |Orange Stripe |Sin+ |A+  |Sin+ |A+  |    |      |   |U+  | 
|2 |Orange        |Sin- |A-  |Sin- |A-  |    |      |   |U-  |
|3 |Green Stripe  |Cos- |B-  |Cos- |B-  |    |      |   |V-  |
|4 |Blue          |Ref- |Z-  |     |    |2   |Blue  |   |W-  |
|5 |Blue Stripe   |Ref+ |Z+  |     |    |1   |Brown |5  |W+  |
|6 |Green         |Cos+ |B+  |Cos+ |B+  |    |      |4  |V+  |
|7 |Brown Stripe  |     |VCC |VCC  |VCC |VCC |Red   |1  |VCC |
|8 |Brown         |GND  |GND |GND  |GND |GND |Black |2  |GND |
|===
